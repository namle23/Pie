CREATE DATABASE  IF NOT EXISTS `dbs` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `dbs`;
...
INSERT INTO `products` VALUES (1,'Batik cake','Cake','Corn flour, butter, sugar, and vanilla','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added.','Sponge cake, cream',10,'1','1_slide','1_thumb'),(2,'Superman cake','Cake','Corn flour, butter, sugar, and vanilla','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. ','Sponge cake, cream',10,'2','2_slide','2_thumb'),(3,'Apple cake','Cake','Apple, caramel icing','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',1,'3','3_slide','3_thumb'),(4,'Applesauce cake','Cake','Prepared using apple sauce, flour and sugar as primary ingredients','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',4,'4','4_slide','4_thumb'),(5,'Aranygaluska','Cake','A cake with yeasty dough and vanilla custard','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',7,'5','5_slide','5_thumb'),(6,'Avocado cake','Cake','Prepared using avocado as a primary ingredient','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',6,'6','6_slide','6_thumb'),(9,'Some random cake','Cake','Corn flour, butter, sugar, and vanilla','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',9,'9','9_slide','9_thumb'),(10,'Cake is good','Cake','Corn flour, butter, sugar, and vanilla','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',10,'10','10_slide','10_thumb'),(11,'Boston cream pie','Cup','Prepared using banana as a primary ingredient','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',5,'11','11_slide','11_thumb'),(12,'Banoffee pie','Cup','	Flour, sugar, ghee (clarified butter), coconut milk, egg yolk','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',8,'12','12_slide','12_thumb'),(7,'Bara brith','Cup','	Chocolate or yellow cake, sugar mixture, various fillings','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',9,'7','7_slide','7_thumb'),(8,'Battenberg cake','Cup','Egg custard, chocolate','Angel food cake, or angel cake, is a type of sponge cake made with egg whites, flour, and sugar. A whipping agent, such as cream of tartar is commonly added. It differs from other cakes because it uses no butter. Its structure comes from whipped egg whites known as a protein foam. ','Sponge cake, cream',3,'8','8_slide','8_thumb');
...
-- Dump completed on 2017-08-13 23:23:36
