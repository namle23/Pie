...
public class ShopAction {
    ...
    public void numberOfPage(int count) {
    ...
    public void displayWithType(int page, int start_prd, String prd_type) throws SQLException {
    ...
    public void displayWithSearch(String searchKeyword, int start_prd) throws SQLException {
    ...
    public void display(int start_prd) throws SQLException {
